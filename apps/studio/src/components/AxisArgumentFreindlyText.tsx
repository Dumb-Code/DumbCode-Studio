...
const AxisArgumentFreindlyText = (axis: string, integer: boolean) => {
  const AxisArgumentFriendlyTextNested = ({ errorData, isParsed }: { errorData: any, isParsed: boolean }) => {
  ...
  return AxisArgumentFriendlyTextNested
}
