...
export class LayoutPart {
    constructor(rootDom, onChanged, contentChanged = () => {}) {
    ...
    set popped(popped) {
        ...
        if(popped) {
            ...
            if(this.win === null) {
                ...
                this.rootDom.detach()
                this.win = window.open('templates/popped_out_colour_picker.html', 'Test Window ' + Math.random(), `top=${top},screenY=${top},left=${left},screenX=${left},height=${height},width=${width}`)
                this.win.onload = () => {
