        ...
        for( var i = 0; i < this.numChains; i++ ){
            ...
            if ( hostChainNumber !== -1 ){
                ...
                switch (constraintType){
                    ...
                    //var connectionBoneMatrix = new M3().createRotationMatrix( hostBone.getDirectionUV() );
...
Object.assign( HISolver.prototype, {
	...
	update: function () {
		...
		//var r = _Math.findAngle(bones[0], bones[1]);
