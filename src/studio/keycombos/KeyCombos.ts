...
const keyCombos = {
  ...
  modeler_copy_only_selected: new KeyCombo('Copy No Children', "Copy only the selected cubes (no children)", "KeyC", true, true).withScope("modeler"),
  modeler_paste_world_position: new KeyCombo('Paste as World', "Paste the cubes in the world position they were copied from", "KeyV", true, true).withScope("modeler"),
  ...
  animator_paste_keyframes_defined: new KeyCombo('Paste as defined', "Pasted the keyframes in defined mode", "KeyV", true, true).withScope("animator"),
