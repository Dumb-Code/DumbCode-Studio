...
const Checkbox = ({value, extraText, props}: {value: boolean, extraText: string, props: any}) => {
    ...
    return(
        <button className={(enabled ? "bg-lightBlue-500" : "bg-gray-700") + " ronuded text-white p-0.5 flex flex-row text-xs rounded mr-1 pt-1.5"} onClick={() => setEnabled(!enabled)} {...props}>
