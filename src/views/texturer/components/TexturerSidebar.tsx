...
const TexturerSidebar = () => {
    return(
        <div className="bg-gray-800 flex flex-col overflow-hidden h-full">
            <TextureProperties />
...
const TextureMapElementProperties = () => {
    return(
        <div className="mb-1">
            ...
            <div className="flex flex-row py-1">
                <div className="mx-1">
                    <p className="text-gray-400 text-xs">MIRROR</p>
                    <div className="px-2">
                        <Checkbox value={false} />
                    </div>
                </div>
                <div className="mx-1">
                    <p className="text-gray-400 text-xs">X OFFSET</p>
                    <NumericInput />
                </div>
                <div className="mx-1">
                    <p className="text-gray-400 text-xs">Y OFFSET</p>
                    <NumericInput />
                </div>
            </div>
        </div>
...
const TexturerLayers = () => {
    return(
        <div className="flex-grow">
            ...
            <div className="bg-gray-800 text-gray-400 font-bold text-xs p-1">
