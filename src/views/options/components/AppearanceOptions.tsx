...
const AppearangeOptions = () => {
    ...
    return (
        <div className="">
            ...
            <button className={(!darkMode || "ring-2 ring-lightBlue-500") + " dark:bg-gray-800 bg-gray-300 rounded w-80 dark:text-white text-black font-semibold p-2 text-left pl-4 my-1"} onClick={() => setDarkMode(true)}>Dark Mode</button>
            <br />
            <button className={(darkMode || "ring-2 ring-lightBlue-500") + " dark:bg-gray-800 bg-gray-300 rounded w-80 dark:text-white text-black font-semibold p-2 text-left pl-4 my-1"} onClick={() => setDarkMode(false)}>Light Mode</button>
            ...
            <br />
            <button className={(!compactMode || "ring-2 ring-lightBlue-500") + " dark:bg-gray-600 bg-gray-400 rounded w-80 dark:text-gray-800 text-gray-600 font-semibold p-2 text-left pl-4 my-1 cursor-not-allowed"} onClick={() => setCompactMode(true)}>Compact Mode</button>
        </div>
    )
}
